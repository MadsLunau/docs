...
<AccordionGroup>
  ...
  <Accordion title="Does Parahelp sign HIPAA Business Associate Agreements (BAAs)?">
    Not yet. Parahelp is actively working toward HIPAA compliance and currently expects to be able to sign Business Associate Agreements (BAAs) around the end of October 2026. This is a current expectation, not a firm guarantee. If you handle protected health information and need a BAA, reach out to your Parahelp contact so we can confirm the latest status. See [our trust page](https://trust.parahelp.com/).
  </Accordion>
</AccordionGroup>
