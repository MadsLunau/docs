...
When in doubt, ask the Internal Agent: it can investigate a ticket, explain a behavior, update a configuration, or connect a new tool for you. Start a task at [app.parahelp.com](https://app.parahelp.com).
