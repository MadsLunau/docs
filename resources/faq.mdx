...
<AccordionGroup>
  <Accordion title="Which ticketing systems does Parahelp support?">
    Intercom, Zendesk, Front, Plain, and Pylon, one per workspace. See [Channels](/customer-agent/channels).
  </Accordion>

  <Accordion title="How do tickets reach my Customer Agent?">
    You set up a workflow in your ticketing system that assigns tickets to Parahelp, so you control exactly which tickets it handles. See [Channels](/customer-agent/channels).
  </Accordion>
</AccordionGroup>
