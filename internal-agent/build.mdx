---
title: "Build"
description: "Describe the support flow you want in natural language, and the Internal Agent builds it."
---

You build your Customer Agent by prompting the **Internal Agent** in a [task](/platform/tasks). Describe the support flow you want in natural language. It builds the scoped policies, knowledge, and tool connections the flow needs, and drafts them for your approval. View your Customer Agent's configurations on the [Configurations page in the app](https://app.parahelp.com/configurations).
...
<Steps>
  ...
  <Step title="The Internal Agent builds it">
    It asks clarifying questions where needed, then builds the flow: the scoped policies, knowledge, and tool connections the agent needs.
  </Step>
