...
Every step the Internal Agent drives - identify gaps, build, test - happens in a task, and so does approving the release that puts a change in front of customers.
