...
When an automation finds a high-leverage improvement, the Internal Agent creates a todo with the relevant context and attributes, assigned to the right user or team - see [Identify gaps](/internal-agent/improve).
